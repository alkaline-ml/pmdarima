...
(Modified BSD 3-clause); I copied it from sklearn/build_tools for pyramid.
...
def cythonize(cython_file, gen_file):
    try:
        ...
        if LooseVersion(cython_version) < LooseVersion('0.21'):
            raise Exception('Building pyramid requires Cython >= 0.21')
