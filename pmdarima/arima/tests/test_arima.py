...
if not travis:
    ...
    def test_plot_diagnostics():
        ...
        # @charlesdrotar if you can figure out how to get this to work
        # on travis our coverage will be much better.
    ...
    def compare_images(expected, actual, tol):
        ...
        comparison_result : None or dict or str
            ...
            Otherwise, a human-readable multi-line string representation of
